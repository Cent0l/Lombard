...
CREATE TABLE Items (
                       ...
                       serial_number VARCHAR(100), -- Changed from INTEGER to VARCHAR
...
CREATE TABLE Transactions (
                              ...
                              expiry_date DATE,
                              related_transaction_id INTEGER REFERENCES Transactions(transaction_id), -- For linking redemptions to original pawns
                              notes TEXT,
                              created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
                              updated_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
